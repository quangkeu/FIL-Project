 ...
 */
public class DynamicTimeSeriesChart extends ApplicationFrame implements ActionListener {
    ...
    public static void main(final String[] args) {
        ...
        final DynamicTimeSeriesChart demo = new DynamicTimeSeriesChart("Dynamic Line And TimeSeries Chart");
        demo.pack();
